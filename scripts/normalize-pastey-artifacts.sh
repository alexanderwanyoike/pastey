...
usage() {
  cat <<'USAGE'
Normalize Pastey package artifacts to stable release names.
...
Environment:
  PASTEY_REQUIRE_UPDATER_ARTIFACTS  Set to 1 to fail if updater artifacts are missing.
USAGE
}
...
CONSOLE_ASSET=""
UPDATER_ASSET=""
REQUIRE_UPDATER_ARTIFACTS="${PASTEY_REQUIRE_UPDATER_ARTIFACTS:-0}"
